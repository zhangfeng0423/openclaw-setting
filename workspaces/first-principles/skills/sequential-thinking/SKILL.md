...
license: MIT
compatibility: mcporter, @modelcontextprotocol/server-sequential-thinking
metadata: {"openclaw": {"emoji": "🧩", "requires": {"mcp": ["sequentialthinking-cloud.sequentialthinking"]}, "primaryEnv": "", "homepage": ""}}
---
...
Use `mcporter call sequentialthinking-cloud.sequentialthinking --args` when:
...
The MCP tool accepts these parameters via `mcporter call sequentialthinking-cloud.sequentialthinking --args '{...}'`:
